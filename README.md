...
```
cd existing_repo
git remote add origin https://git.cs.bham.ac.uk/dxj351/recipe_browser.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.cs.bham.ac.uk/dxj351/recipe_browser/-/settings/integrations)
